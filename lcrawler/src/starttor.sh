...
do
	...
	echo "Running: tor --RunAsDaemon 1 --CookieAuthentication 0 --ControlPort $control_port --PidFile tor$i.pid --SocksPort $socks_port --DataDirectory data/tor$i"
